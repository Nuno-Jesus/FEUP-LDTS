...
import g1001.Buttons.ContinueButton;
import g1001.Buttons.QuitButton;
...
public class PauseState implements State{
  ...
  public PauseState(Maze maze){
    selected = 0;
    buttons = new ArrayList<>();

    buttons.add(new ContinueButton(26, 21, new PlayState(maze)));
    buttons.add(new QuitButton(26, 29,  new MenuState()));
