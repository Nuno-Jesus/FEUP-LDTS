...
public class ListDeduplicatorTest {
    ...
    @Test
    //Isolating ListDeduplicator.deduplicate() from ListSorter.sort() to test distinct
    public void deduplicate_bug_8726(){
        ...
        test = deduplicator.deduplicate(test);

        Assertions.assertEquals(Arrays.asList(1, 2, 4), test);
    }
}
